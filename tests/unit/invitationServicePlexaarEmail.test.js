        ...
        const message = {
            ...
            message: {
                value: JSON.stringify({
                    ...
                    eventName: 'Plexaar Service Provider Invitation',
                    placeholder: 'test data',
                }),
                headers: { eventType: Buffer.from('PlexaarServiceProvider_invitation') },
                offset: '0',
            },
        };
...
const { InvitationServicePlexaarEmail } = require('../../utils/consumer3')

const { sendEmail } = require('../../utils/sendEmail');
const { parseTemplate } = require('../../utils/parseTemplate');

describe('InvitationServicePlexaarEmail function', () => {
    beforeEach(() => {
        jest.clearAllMocks();
    });
    ...
    it('processes Kafka message and sends email for "plexaar_staff_invitation" event type', async () => {
        ...
        await InvitationServicePlexaarEmail({ topic: 'test1' });
